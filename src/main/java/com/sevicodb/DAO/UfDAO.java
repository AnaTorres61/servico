...
public class UfDAO extends ConexaoDB {
    ...
    public void insertUf(Uf entidade) {
        try (PreparedStatement preparedStatement = prapararSQL(INSERT_UF_SQL)) {
    ...
    public Uf selectUf(int id) {
        Uf entidade = null;
        try (PreparedStatement preparedStatement = prapararSQL(SELECT_UF_BY_ID)) {
    ...
    public List<Uf> selectAllUfs() {
        ...
        try (PreparedStatement preparedStatement = prapararSQL(SELECT_ALL_UF)) {
            ResultSet rs = preparedStatement.executeQuery();
    ...
    public boolean deleteUf(int id) throws SQLException {
        try (PreparedStatement statement = prapararSQL(DELETE_UF_SQL)) {
    ...
    public boolean updateUf(Uf entidade) throws SQLException {
        try (PreparedStatement statement = prapararSQL(UPDATE_UF_SQL)) {
